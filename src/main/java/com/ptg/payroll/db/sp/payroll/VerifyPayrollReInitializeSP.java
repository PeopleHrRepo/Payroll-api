...
public class VerifyPayrollReInitializeSP extends StoredProcedure {

    private static final Logger log = LoggerFactory.getLogger(VerifyPayrollReInitializeSP.class);

    private static final String SP_NAME = "TRINET_PAYROLL_ENTRY.spc_VerifyPayrollReInitialize";
    ...
    private static final String OUT_COUNT = "o_Count";
    private static final String OUT_ENGSTATUS = "o_EngStatus";
    private static final String OUT_ERR_MSG = "o_ErrMsg";

    public VerifyPayrollReInitializeSP(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter(OUT_COUNT, Types.INTEGER));
        declareParameter(new SqlOutParameter(OUT_ENGSTATUS, Types.VARCHAR));
        declareParameter(new SqlOutParameter(OUT_ERR_MSG, Types.VARCHAR));

        compile();
    }

    public boolean verifyPayrollReInitialize(PayGroup payGroup) {
    	boolean isMidPayExists = false;
        ...
        Integer count = (Integer) output.get(OUT_COUNT);
        String engStatus = (String) output.get(OUT_ENGSTATUS);

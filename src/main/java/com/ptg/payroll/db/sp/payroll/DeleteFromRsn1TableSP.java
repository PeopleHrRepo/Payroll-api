...
public class DeleteFromRsn1TableSP extends StoredProcedure {

    private static final Logger log = LoggerFactory.getLogger(DeleteFromRsn1TableSP.class);

    private static final String SP_NAME = "TRINET_PAYROLL_ENTRY.spc_DeleteFromRsn1Table";
    ...
    public DeleteFromRsn1TableSP(DataSource dataSource) {
    ...
    public void deleteFromRsn1Table(PayGroup payGroup, String userEmployeeId) {
        ...
        if (isError) {
            log.error("SQL Error:" + error + " Payroll DeleteFromRsn1Table failed : sp {}, parameters:{}", SP_NAME, inputs);
            throw new GatewayBackendException("SQL Error:" + " couldn't deleteFromRsn1Table :");
        }

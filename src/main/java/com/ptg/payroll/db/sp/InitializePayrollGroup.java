...
import com.ptg.payroll.db.sp.payroll.payrollentry.IInitializePayrollGroup;
 ...
 *
 */
public class InitializePayrollGroup extends StoredProcedure implements IInitializePayrollGroup {
	
	private static final Logger log = LoggerFactory.getLogger(InitializePayrollGroup.class);

	private static final String SP_NAME = "TRINET_PAYROLL_ENTRY.spc_InitializeCoPayroll";
    ...
    public InitializePayrollGroup(DataSource dataSource){
	...
	public void execute(String company, String payGroup, Date payBeginDate,
			Date payEndDate, String oprId) throws GatewayBackendException {
		...
		log.debug("inside Initialize Payroll Group");

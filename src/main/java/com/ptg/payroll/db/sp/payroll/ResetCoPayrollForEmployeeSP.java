...
public class ResetCoPayrollForEmployeeSP extends StoredProcedure {

    private static final Logger log = LoggerFactory.getLogger(ResetCoPayrollForEmployeeSP.class);

    private static final String SP_NAME = "TRINET_PAYROLL_ENTRY.spc_ResetCoPayrollForEmployee";
    ...
    public ResetCoPayrollForEmployeeSP(DataSource dataSource) {
    ...
    public void execute(PayGroup payGroup, String employeeId) {

        Map<String, Object> inputs = new HashMap<String, Object>();
        
        inputs.put(IN_COMPANY, payGroup.getCompany());
        inputs.put(IN_EMPLID, employeeId);
        ...
        if (isError) {
            log.error("SQL Error:" + error + " Payroll Reset For " + employeeId + " failed : sp {}, parameters:{}", SP_NAME, inputs);
            throw new GatewayBackendException("SQL Error:" + " couldn't reset employee payroll:");
        }
